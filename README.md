...
<div align="center">
  <img src="https://github.com/huidong-ma/WeLab/blob/main/img.png" width="600" alt="An example.">
</div>
...
chmod +x ./WeLab/tools/analyze ./WeLab/tools/notify
```
### II. Ollama
```
...
```
Add `./bin` to the environment variables, and download the LLM model `qwen3:8b`:
```
ollama serve
